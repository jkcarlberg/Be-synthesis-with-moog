...
c     JKC comment/ index of xmol/xamol comes from order in largemollist in Bmolec.f?
c  YES! This means that everything after  Hydrogen will use the WRONG number density if smallmollist is set
c     So I fixed it! Don't need depth dependent information for ones outside of molecular equilibrium calculation

c   Had to increase size of numdens to be able to pass NH around
      if (molset .eq. 0) then
         do i=1,ntau
            numdens(1,1,i) = xamol(1,i)                                    H I
            numdens(1,2,i) = xmol(1,i)                                     H II
            numdens(2,1,i) = xabund(2)*xamol(1,i)                          He I
            numdens(2,2,i) = xabund(2)*xamol(1,i)                          He II. Hopefully gets scaled by partition function?
            numdens(3,1,i) = xamol(2,i)                                    C I
            numdens(4,1,i) = xabund(12)*xamol(1,i)                         Mg I
            numdens(4,2,i) = xabund(12)*xamol(1,i)                         Mg II
            numdens(5,1,i) = xabund(13)*xamol(1,i)                         Al I
            numdens(5,2,i) = xabund(13)*xamol(1,i)                         Al II
            numdens(6,1,i) = xabund(14)*xamol(1,i)                         Si I
            numdens(6,2,i) = xabund(14)*xamol(1,i)                         Si II
            numdens(7,1,i) = xabund(26)*xamol(1,i)                         Fe I
            numdens(7,2,i) = xabund(26)*xamol(1,i)                         Fe II
            numdens(3,2,i) = xmol(2,i)                                     C II
            numdens(8,1,i) = xmol(7,i)                                     H_2
            numdens(8,2,i) = xmol(8,i)                                     CH (I hope)
            numdens(9,1,i) = xmol(9,i)                                     NH
         enddo
      else
         do i=1,ntau
            numdens(1,1,i) = xamol(1,i)                                    H I
            ...
            numdens(8,2,i) = xmol(18,i)                                    CH (I hope)
            numdens(9,1,i) = xmol(19,i)                                    NH
         enddo
         endif
